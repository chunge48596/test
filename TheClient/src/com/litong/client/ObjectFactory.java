 ...
 * generated in the com.litong.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://service.litong.com/", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://service.litong.com/", "getValueResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.litong.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.litong.com/", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.litong.com/", name = "getValueResponse")
