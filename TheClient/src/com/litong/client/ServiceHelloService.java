 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://service.litong.com/", wsdlLocation = "http://localhost:8089/Service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://service.litong.com/", "ServiceHelloService");
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://service.litong.com/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.litong.com/", "ServiceHelloPort"), ServiceHello.class, features);
    }
